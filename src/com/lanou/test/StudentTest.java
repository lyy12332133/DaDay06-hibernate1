...
public class StudentTest {
    // session的工厂类对象, 线程安全的, 一个数据库对应一个session工厂对象
    // 通常在项目启动时初始化该对象, 用Configuration对象创建
    private SessionFactory sessionFactory;
    // 真正执行CRUD操作的数据库连接对象, 代表了一次数据库连接, 是非线程安全的
    private Session session;
    // 事物对象, 与jdbc中的事物类似, 只不过hibernate中的事物是不自动提交的,
    // 而jdbc中的事物是会自动提交, hibernate中的事物需要手动提交
    ...
    /**
     * 销毁操作
     * After 在Test注解之后执行的方法, 通常该方法做一些释放, 关闭的操作
     */
    @After
    public void destroy() {
